...
#include <memory>
#include "../../../GameCPP/ItemFactory/sword.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Sword_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Sword_t qt_meta_stringdata_Sword = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Sword[] = {
...
Q_CONSTINIT const QMetaObject Sword::staticMetaObject = { {
    ...
    qt_meta_stringdata_Sword.offsetsAndSizes,
    qt_meta_data_Sword,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Sword_t,
        // Q_OBJECT / Q_GADGET
