...
Q_CONSTINIT static const qt_meta_stringdata_Map_t qt_meta_stringdata_Map = {
    {
        ...
        QT_MOC_LITERAL(4, 21),  // "displayedTilesChanged"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 5)   // "tiles"
    },
    "Map",
    "displayedTilesChanged",
    "",
    "tiles"
};
...
void Map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayedTilesChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (Map::*)();
            if (_t _q_method = &Map::displayedTilesChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVariant*>(_v) = _t->getDisplayedTiles(); break;
        default: break;
        }
...
// SIGNAL 0
void Map::displayedTilesChanged()
{
